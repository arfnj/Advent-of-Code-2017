...
// on knot-tying. The hash these programs are implementing isn't very strong, but you decide to help
// them anyway. You make a mental note to remind the Elves later not to invent their own
...
const sequence = [225,171,131,2,35,5,0,13,1,246,54,97,255,98,254,110];
...
// instead. Unless otherwise specified, convert characters to bytes using their ASCII codes. This
// will allow you to handle arbitrary ASCII strings, and it also ensures that your input lengths are
// never larger than 255. For example, if you are given 1,2,3, you should convert it to the ASCII
...
// between 0 and 255 (inclusive), always represent each number as two hexadecimal digits (including
// a leading zero as necessary). So, if your first three numbers are 64, 7, 255, they correspond to
// the hexadecimal numbers 40, 07, ff, and so the first six characters of the hash would be 4007ff.
...
const knotMaker = () => {
	...
	console.log(dense.reduce((knot,num) => {
